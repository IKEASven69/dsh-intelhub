...
_computedKey = Service.init, _dec = Remote("status"), _dec1 = Remote("list"), _dec2 = Remote("import"), _dec3 = Remote("remove"), _dec4 = Remote("search"), _dec5 = Remote("url-import"), _dec6 = Remote("note"), _dec7 = Remote("upload"), _dec8 = Remote("demo"), _dec9 = Remote("workspace-add"), _dec10 = Remote("workspace-remove"), _dec11 = Remote("workspace-list"), _dec12 = Remote("schedule-list"), _dec13 = Remote("schedule-set"), _dec14 = Remote("schedule-remove"), _dec15 = Remote("schedule-toggle");
